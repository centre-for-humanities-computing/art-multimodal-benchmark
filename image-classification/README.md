...
This repository contains the code accompanying the image classification and object detection tasks for the paper *A Benchmark Dilemma*.

## Project Structure

```
art-multimodal-benchmark/image-classification
│
