"""
Extract embeddings from HuggingFace dataset with images
"""
...
def argument_parser():
    ...
    parser.add_argument('--out_folder_name', type=str, help="name of output folder for embeddings")
...
def main():
    ...
    embeddings_outpath = os.path.join('data', args['out_folder_name'])
