...
#python3 src/embeddings_wikidata.py --models __/eva02_clip_336 --dataset wikidata
...
#python3 src/classification_wikidata.py --dataset wikidata_remapped --model_names CLIP-ViT-B-16-DataComp.XL-s13B-b90K